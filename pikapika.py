...
import cv2
img = cv2.imread('C:/Users/rajpu/Desktop/data/Pikachu/b.jpg', cv2.IMREAD_UNCHANGED)
...
desired_size = 368
im_pth = "C:/Users/rajpu/Desktop/data/Pikachu/a.jpg"
...
cv2.imwrite('C:/Users/rajpu/Desktop/a.jpg', new_im) 
...
images = [cv2.imread(file) for file in glob.glob("C:/Users/rajpu/Desktop/data/Pikachu/*.jpg")]

images_1 = [cv2.imread(file) for file in glob.glob("C:/Users/rajpu/Desktop/data/Butterfree/*.jpg")]

images_2 = [cv2.imread(file) for file in glob.glob("C:/Users/rajpu/Desktop/data/Ditto/*.jpg")]
